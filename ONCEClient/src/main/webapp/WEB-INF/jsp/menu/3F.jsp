		...
		<div class="container">
			...
			<div class="row">
				<div class="col s6">
					<div class="entry">
						<head>
							<img src="${pageContext.request.contextPath}/resources/img/logo5.jpg" alt="">
						</head>
						<div class="content">
							<h6>자라</h6>
							<p>SPA</p>
				...
				<div class="col s6">
					<div class="entry">
						<head>
							<img src="${pageContext.request.contextPath}/resources/img/logo6.png" alt="">
						</head>
						<div class="content">
							<h6>유니클로</h6>
							<p>SPA</p>
							<ul>
								<ll><i class="fa fa-phone-square"></i>:02-5678-9101</ll>
							</ul>
						</div>
					</div>
				</div>
